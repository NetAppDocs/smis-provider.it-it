...
[role="lead"]
Se usi un firewall diverso da quello predefinito di Windows, NetApp SMI-S Provider potrebbe non riuscire a comunicare con i client o a inviare indicazioni, a meno che le porte necessarie non vengano aggiunte come eccezioni. Aggiungi queste porte alla configurazione del firewall per risolvere il problema.
