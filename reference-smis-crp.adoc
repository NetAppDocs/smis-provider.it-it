...
summary: Il comando smi crp descrive i profili registrati con CIM supportati dal provider SMI-S di NetApp, inclusi i profili SMI-S Provider di NetApp. 
---
= crp. smi
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `smis crp` Il comando descrive i profili registrati con CIM supportati dal provider SMI-S di NetApp, inclusi i profili SMI-S Provider di NetApp.
...
.Esempio
Il `smis crp` comando e relativo output:
