...
[role="lead"]
NetApp SMI-S Provider release notes descrivono le nuove funzionalità, le note di aggiornamento, i problemi risolti e le limitazioni note per ogni versione. Trova le note di rilascio attuali per NetApp SMI-S Provider 5.2.7 qui.
