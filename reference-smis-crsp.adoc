...
summary: Il comando smi crsp descrive i sottoprofili registrati con CIM supportati da NetApp SMI-S Provider, inclusi i sottoprofili NetApp SMI-S Provider. 
---
= smi crsp
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `smis crsp` Il comando descrive i sottoprofili registrati con CIM supportati dal NetApp SMI-S Provider, inclusi i sottoprofili NetApp SMI-S Provider.
...
.Esempio
Il `smis crsp` comando e relativo output abbreviato:
