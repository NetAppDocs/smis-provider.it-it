...
image::../media/smi_s_agent_and_host_interaction.gif[Un diagramma che mostra un host che invia query al provider SMI-S CIMOM, repository, alle DLL del provider e al sistema storage]
