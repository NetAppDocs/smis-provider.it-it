...
[role="lead"]
Non puoi aggiungere un sistema storage NetApp al NetApp SMI-S Provider quando quel sistema utilizza HTTP o HTTPS su una porta diversa da quella predefinita. Aggiungi il sistema storage specificando esplicitamente la porta non predefinita.
