...
[role="lead"]
Le password che contengono caratteri speciali possono causare il comando  `smis` a non funzionare in ambiente Windows. Racchiudi queste password tra virgolette doppie per inserirle correttamente.
