...
[role="lead"]
NetApp SMI-S Provider può occasionalmente bloccarsi in un ambiente Windows. Raccogli i file di dump, di registro e di traccia generati al momento del blocco e inviali al supporto tecnico per ulteriori analisi.
