...
[role="lead"]
NetApp SMI-S Provider 5.2.7 introduce nuovi requisiti e limitazioni, tra cui le versioni di Windows e System Center Virtual Machine Manager (SCVMM) supportate. Esamina queste modifiche prima di implementare o aggiornare a questa versione.
